...
void loop()
{
  int keyInput, versionNum, statusNum;
  versionNum = lcd.version();
  ...
  lcd.print("   "); 
  lcd.println((keyInput-48),DEC);      // Print the value we got back from the keypad 
  lcd.print("Ver = ");
  lcd.print(versionNum, DEC);
  lcd.print(" Status = ");
  lcd.print(statusNum, DEC);
  delay(10);
}
